...
public class ApiClient {
    ...
    private String basePath = "https://veritas-nonprod-dev.apigee.net/velocity-sandbox/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://veritas-nonprod-dev.apigee.net/velocity-sandbox/v1
